...
function Header() {
  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-light p-3 fixed-top" style={{backgroundColor:"#891652"}}>
      <div className="container-fluid " >
        <Link className="navbar-brand d-flex align-items-center gap-2 new-navbar3" to="/" style={{color:"#FFF3C7",fontSize:"23px"}}>
        <FaShopify /> Super~Mart
        </Link>
       <Search/>
        <button
